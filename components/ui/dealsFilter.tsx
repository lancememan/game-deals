...
const dealsFilter = () => {
  ...
  return (
    <>
    <FilterButton isOpen={isOpen} updateState={setIsOpen} />
    <div className={`filter-col w-[600] max-w-full fixed right-0 top-0 h-screen pt-8 text-lg bg-background border-gray-400/30 px-10 xl:border-l xl:basis-1/4 transform transition-transform duration-500 ease-in-out 
      ...
      <Form action={handleSubmit}>
        ...
        <button type="submit" className="px-3 py-1 rounded-md border float-end border-gray-300/50 text-white/70 hover:bg-gray-800/80 cursor-pointer block w-full">Submit</button>
      </Form>
    </div>
    </>
  )
